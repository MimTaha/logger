...
class ColorText {
public:
    static void print(int textColor, int bgColor, const char *string,va_list args);
                                                                     
    static void print(int textColor, int bgColor, const char *string,...);

    static char *getTxtColor(int textColor, int bgColor, const char *string, va_list args);
